...
func (ctx *SigningContext) digest(el *xmltree.Element) ([]byte, error) {
...
func (ctx *SigningContext) constructSignedInfo(el *xmltree.Element, enveloped bool) (*xmltree.Element, error) {
...
func (ctx *SigningContext) ConstructSignature(el *xmltree.Element, enveloped bool) (*xmltree.Element, error) {
...
func (ctx *SigningContext) createNamespacedElement(el *xmltree.Element, tag string) *xmltree.Element {
	child := el.CreateElement(tag)
	child.Space = ctx.Prefix
	return child
}

func (ctx *SigningContext) SignEnveloped(el *xmltree.Element) (*xmltree.Element, error) {
