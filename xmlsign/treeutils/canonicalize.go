...
func TransformExcC14n(el *xmltree.Element, inclusiveNamespacesPrefixList string) error {
...
func transformExcC14n(ctx, declared NSContext, el *xmltree.Element, inclusiveNamespaces map[string]struct{}) error {
