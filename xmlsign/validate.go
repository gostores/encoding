...
func inNamespace(el *xmltree.Element, ns string) bool {
...
// The RemoveElement method on xmltree.Element isn't recursive...
func recursivelyRemoveElement(tree, el *xmltree.Element) bool {
...
func (ctx *ValidationContext) transform(
	el *xmltree.Element,
	sig *types.Signature,
	ref *types.Reference) (*xmltree.Element, Canonicalizer, error) {
...
func (ctx *ValidationContext) digest(el *xmltree.Element, digestAlgorithmId string, canonicalizer Canonicalizer) ([]byte, error) {
...
func (ctx *ValidationContext) validateSignature(el *xmltree.Element, sig *types.Signature, cert *x509.Certificate) (*xmltree.Element, error) {
...
func (ctx *ValidationContext) findSignature(el *xmltree.Element) (*types.Signature, error) {
	idAttr := el.SelectAttr(ctx.IdAttribute)
	if idAttr == nil || idAttr.Value == "" {
		return nil, errors.New("Missing ID attribute")
	}
	...
	err := treeutils.NSFindIterate(el, Namespace, SignatureTag, func(ctx treeutils.NSContext, el *xmltree.Element) error {
		...
		err := treeutils.NSFindIterateCtx(ctx, el, Namespace, SignedInfoTag,
			func(ctx treeutils.NSContext, signedInfo *xmltree.Element) error {
				...
				var canonicalSignedInfo *xmltree.Element
...
func (ctx *ValidationContext) Validate(el *xmltree.Element) (*xmltree.Element, error) {
