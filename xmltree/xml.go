...
// Package xmltree provides XML services through an Element Tree
// abstraction.
package xmltree
...
var ErrXML = errors.New("xmltree: invalid XML format")
...
// depth level is given as spaces. Pass xmltree.NoIndent for spaces if you want
