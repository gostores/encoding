...
func TestDocument(t *testing.T) {
	...
	if err != nil {
		t.Error("xmltree: failed to serialize document")
	}
...
`
	...
	if doc.Root() != store {
		t.Error("xmltree: root mismatch")
	}
	if len(store.ChildElements()) != 1 || len(store.Child) != 7 {
		t.Error("xmltree: incorrect tree structure")
	}
	...
	if len(elements) != 1 || elements[0] != store {
		t.Error("xmltree: incorrect SelectElements result")
	}
	element := doc.SelectElement("store")
	if element != store {
		t.Error("xmltree: incorrect SelectElement result")
	}
	...
	if attr == nil || attr.Key != "lang" || attr.Value != "en" {
		t.Error("xmltree: incorrect SelectAttr result")
	}
	if book.SelectAttrValue("lang", "unknown") != "en" {
		t.Error("xmltree: incorrect SelectAttrValue result")
	}
	...
	if attr.Value != "en" {
		t.Error("xmltree: incorrect RemoveAttr result")
	}
	...
	if element != title {
		t.Error("xmltree: incorrect RemoveElement result")
	}
	element = book.SelectElement("title")
	if element != nil {
		t.Error("xmltree: incorrect SelectElement result")
...
func TestDocumentRead_NonUTF8Encodings(t *testing.T) {
	...
	if err != nil {
		t.Fatal("xmltree: incorrect ReadFromString result")
	}
}
...
func TestWriteSettings(t *testing.T) {
	...
	s, err := doc.WriteToString()
	if err != nil {
		t.Error("xmltree: WriteSettings WriteTo produced incorrect result.")
	}
...
func TestCopy(t *testing.T) {
	...
	if err != nil {
		t.Error("xmltree: incorrect WriteToString result")
	}

	doc2 := doc.Copy()
	s2, err := doc2.WriteToString()
	if err != nil {
		t.Error("xmltree: incorrect Copy result")
	}

	if s1 != s2 {
		t.Error("xmltree: mismatched Copy result")
		t.Error("wanted:\n" + s1)
		t.Error("got:\n" + s2)
	}
	...
	if e1 == nil || e2 == nil {
		t.Error("xmltree: incorrect FindElement result")
	}
	if e1 == e2 {
		t.Error("xmltree: incorrect FindElement result")
	}
	...
	if s1 == s2 {
		t.Error("xmltree: incorrect result after RemoveElement")
	}
}
...
`
	...
	if err != nil {
		t.Fatal("xmltree ReadFromString: " + err.Error())
	}
